...
def run_test_instructions():
    # With 5.6 we are dropping older osx versions from CI, while those
    # are having default python with outdated pip
    if CI_HOST_OS_VER in ["OSX_10_08", "OSX_10_10"]:
        print("Disabled " + CI_HOST_OS_VER + " from Coin configuration")
        exit()
    # Disabling 32 bit cross compilation test
