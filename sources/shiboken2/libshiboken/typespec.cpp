...
offsetof(PyHeapTypeObject, as_number.nb_nonzero), // nb_bool),
...
0, // offsetof(PyHeapTypeObject, as_number.nb_matrix_multiply),
0, // offsetof(PyHeapTypeObject, as_number.nb_inplace_matrix_multiply),
0, // offsetof(PyHeapTypeObject, as_async.am_await),
0, // offsetof(PyHeapTypeObject, as_async.am_aiter),
0, // offsetof(PyHeapTypeObject, as_async.am_anext),
0, // offsetof(PyHeapTypeObject, ht_type.tp_finalize),
};
